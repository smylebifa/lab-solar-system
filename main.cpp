...
{
    /* ¬ысота 1.0  - это 768 пиксилей, если высота монитора больне, следовательно веществеенное значение больше
       “ака€ же ситуаци€ с шириной. —делано дл€ того, чтобы разрешение экрана давало приимущество*/
